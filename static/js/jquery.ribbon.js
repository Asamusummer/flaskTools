...
/*
Copyright (c) 2009 Mikael S?derstr?m.
...
(function($) {
    ...
    $.fn.Ribbon = function(ribbonSettings) {
       ...
       // $('head').append('<link href="/common/ribbon/ribbon/themes/' + settings.theme + '/ribbon.css" rel="stylesheet" type="text/css" />');
       ...
       // $('.orb li:first ul:first').prepend('<img src="/common/ribbon/ribbon/themes/' + settings.theme + '/images/menu_top.png" style="margin-left: -10px; margin-top: -22px;" />');
       // $('.orb li:first ul:first').append('<img src="/common/ribbon/ribbon/themes/' + settings.theme + '/images/menu_bottom.png" style="margin-left: -10px; margin-bottom: -22px;" />');

       // $('.ribbon-list div').each(function() { if ($(this).children('ul').length > 0) { $(this).append('<img src="/common/ribbon/ribbon/themes/' + settings.theme + '/images/arrow_down.png" style="float: right; margin-top: 5px;" />') } });

        //Hack for IE 7.
        if (navigator.appVersion.indexOf('MSIE 6.0') > -1 || navigator.appVersion.indexOf('MSIE 7.0') > -1) {
            $('ul.menu li li div').css('width', '90px');
            $('ul.menu').css('width', '900px');

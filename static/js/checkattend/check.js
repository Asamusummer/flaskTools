...
var content_div = new Vue({
    ...
    methods: {
        ...
        getallcalData: function () {
            ...
            $.ajax({
                type: 'GET',
                url: '/checkdataboard/get_calendar_list/',
        ...
        getworkerattendlist: function() {
            ...
            $.ajax({
                type: 'GET',
                url: '/checkdataboard/getworkerattendlist/',
                success: function (data) {
        ...
        getSlideList: function() {
            ...
            $.ajax({
                type: 'GET',
                url: '/checkdataboard/get_slide_info/',
        ...
        getAttendList: function() {
            ...
            $.ajax({
                type: 'GET',
                url: '/checkdataboard/get_attend_list/',
                data: {'filter_date': _self.filterDate},
                success: function (data) {
        ...
        getAttendDetail: function(depart_id) {
            ...
            $.ajax({
                type: 'GET',
                url: '/checkdataboard/get_depart_attend_detail/',
        ...
        getVisitList: function() {
            ...
            $.ajax({
                type: 'GET',
                url: '/checkdataboard/get_visit_list/',
                data: {'filter_date': _self.filterDate},
                dataType: "json",
                success: function (data) {
                    if (data.status=='200') {
        ...
        getWarningRecords: function(){
            ...
            $.ajax({
                type:'GET',
                url:'/checkdataboard/getwarningrecords/',
                data: {'filter_date': _self.filterDate},
        ...
        getnewdata: function(){
            ...
            $.ajax({
                type:'GET',
                url:'/checkdataboard/getnewdata/',
                success:function (resp) {
                    document.getElementById('nowpeople').innerText = resp.allnum + '人'
                    document.getElementById('late').innerText= resp.late + '人'
                    document.getElementById('todayattend').innerText = resp.checknum +'人';
        ...
        getallattendData: function () {
            ...
            $.ajax({
                type: 'GET',
                url: '/checkdataboard/get_all_attend_data/',
                    ...
                    if (_self.losslist.length > 0) {
                        ...
                        _self.yellowoption = {
                            ...
                            series: [{
                                ...
                                data: [{
                                    ...
                                    name: '02',
                                    value: _self.losslist[0] + _self.losslist[2],
                                    itemStyle: {
                                        normal: {
                                            color: { // 完成的圆环的颜色
                                                colorStops: [{
                        ...
                        _self.redoption = {
                            ...
                            series: [{
                                ...
                                data: [{
                                    ...
                                    name: '02',
                                    value: _self.laterlist[0] + _self.laterlist[1],
                                    itemStyle: {
                                        normal: {
                                            color: { // 完成的圆环的颜色
                                                colorStops: [{
                        ...
                        _self.$nextTick(function () {
                            ...
                            _self.wrong_attend_chart.getZr().on('click', function (params) {
                                 var frameSrc = "/checkdataboard/get_employ_list/?filter_type=1";
                                $("#NoPermissioniframe").attr("src", frameSrc);
                                $('#NoPermissionModal').modal({ show: true, backdrop: 'static' });
                                $("#NoPermissionModalLabel").html("考勤详情")
                            });
        ...
        getAttendInfo: function (attend_state) {
            // 查看考勤详情
            window.location.href = '/checkdataboard/getattendinfo/?attend_state=' + attend_state
        }
    },
});
...
function Buttonclick(e) {
    ...
    $.ajax({
        type: 'GET',
        url: '/checkdataboard/getbuildingdevicesta/',
        data: {
            floor: thefloor,
            type: dev_type
        },

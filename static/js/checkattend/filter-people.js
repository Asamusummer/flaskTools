...
var main = new Vue({
  ...
  methods: {
    getALLPeopleAttendSate:function() {
      ...
      $.ajax({
        type: 'GET',
        url: '/checkdataboard/getalluserattendstate/',
    ...
    getDepartList:function() {
      ...
      $.ajax({
        type: 'GET',
        url: '/checkdataboard/get_depart_list/',
        success: function (data) {
    ...
    getWarnTmpList:function() {
      ...
      $.ajax({
        type: 'GET',
        url: '/checkdataboard/getwarntemplist/',
    ...
    //   var frameSrc = "/checkdataboard/userdetailshowpage/?user_id=" + id + "&" + "date=" + datea;
